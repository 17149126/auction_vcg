...
public class AuctionVcg2 {
	...
	public static void main1(String[] args) {
		Vcg vcg = new Vcg();
		Limitation limitation = new Limitation(20);
		Output output = new Output();
		
		ArrayList<Bid> al = new ArrayList<Bid>();

		// Here we have four bids
		Bid bid2 = new Bid("Akash", "Cork", "11", "Student", null, 11.0);
		...
		al.add(new Bid("Test2", "Galway", "12", "engineer", null, 27.0
				));
		...
		Bid finalBid = vcg.secondPriceOcution(al);
